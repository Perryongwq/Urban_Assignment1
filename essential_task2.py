...
def wifi_print(site, floor, savepath=None, cbarange=None, selectmethod='random 3'):
    ...
    if selectmethod == 'input':
        ...
        plt.savefig(savepath, dpi=160) if savepath else plt.show()
    else:
